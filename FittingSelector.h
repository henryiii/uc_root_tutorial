...
// Tue Jun 20 22:54:13 2017 by ROOT version 6.10/00
// from TTree XiDecayTuple/XiDecayTuple
// found on file: DVntuple-March04A.root
//////////////////////////////////////////////////////////

#ifndef FittingSelector_h
#define FittingSelector_h
...
class FittingSelector : public TSelector {
public :
   ...
   FittingSelector(TTree * /*tree*/ =0) { }
   virtual ~FittingSelector() { }
   ...
   ClassDef(FittingSelector,0);

};

#endif

#ifdef FittingSelector_cxx
void FittingSelector::Init(TTree *tree)
{
...
#endif // #ifdef FittingSelector_cxx
