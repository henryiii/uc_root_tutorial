...
// Mon Jun 19 23:00:08 2017 by ROOT version 6.10/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxXi_ENDVERTEX_COV = 1;
   static constexpr Int_t kMaxXi_OWNPV_COV = 1;
   static constexpr Int_t kMaxPromptPi_OWNPV_COV = 1;
   static constexpr Int_t kMaxPromptPi_ORIVX_COV = 1;
   static constexpr Int_t kMaxLambda_ENDVERTEX_COV = 1;
   static constexpr Int_t kMaxLambda_OWNPV_COV = 1;
   static constexpr Int_t kMaxLambda_ORIVX_COV = 1;
   static constexpr Int_t kMaxDecayPi_OWNPV_COV = 1;
   static constexpr Int_t kMaxDecayPi_ORIVX_COV = 1;
   static constexpr Int_t kMaxDecayPr_OWNPV_COV = 1;
   static constexpr Int_t kMaxDecayPr_ORIVX_COV = 1;
...
#ifdef Xi_Analysis_cxx
Xi_Analysis::Xi_Analysis(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("DVntuple-March04A.root:/myXiTuple");
      dir->GetObject("XiDecayTuple",tree);
...
Int_t Xi_Analysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Xi_Analysis::LoadTree(Long64_t entry)
{
...
void Xi_Analysis::Init(TTree *tree)
{
...
void Xi_Analysis::Show(Long64_t entry)
{
...
Int_t Xi_Analysis::Cut(Long64_t entry)
{
